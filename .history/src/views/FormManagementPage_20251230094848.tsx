...
import { Edit2, Trash2, Plus, ArrowLeft, Loader2, FileText, Calendar } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-800 p-8 rounded-[2rem] border border-slate-700 shadow-2xl">
        <div>
          <h1 className="text-4xl font-black text-white flex items-center gap-3">
            <FileText className="text-blue-500" size={36} /> Custom Forms
          </h1>
          ...
          {forms.map((form) => (
            ...
            >
              <div>
                ...
                <div className="flex items-center gap-4 mt-6 text-slate-500">
                    <div className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-tighter">
                        <Calendar size={14} /> {new Date(form.created_at).toLocaleDateString()}
                    </div>
              ...
              <div className="flex gap-3 mt-8">
                ...
                >
                  {isFetchingDetails ? <Loader2 size={16} className="animate-spin" /> : <Edit2 size={16} />}
                  Edit
                </button>
                <button
