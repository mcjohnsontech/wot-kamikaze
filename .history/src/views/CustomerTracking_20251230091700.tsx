    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100">
      ...
      <div className="bg-white border-b border-blue-100 sticky top-0 z-40 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          <p className="text-slate-600 flex items-center gap-2">
            <span>🚴</span>
            <span aria-live="polite">{order.status === 'DISPATCHED' ? 'Your rider is on the way' : `Status: ${order.status}`}</span>
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="border-4 border-blue-300 rounded-2xl overflow-hidden shadow-lg mb-6 h-96 bg-white">
          ...
          {!riderPos && (
            <div role="status" className="h-full flex items-center justify-center text-slate-500">
              <div className="text-center">
        ...
        <div className="bg-gradient-to-r from-orange-400 to-orange-500 text-white rounded-2xl p-6 mb-6 shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 aria-live="polite" className="text-5xl font-bold">{eta > 0 ? `${eta} min` : 'Calculating...'}</h2>
            </div>
