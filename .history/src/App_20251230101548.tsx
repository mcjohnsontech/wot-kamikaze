      ...
      <AuthProvider> {/* Wrap the entire application with the Auth Provider */}
        <Router>
          <Routes>
            ...
            {/* 3. Protected SME Dashboard (FR: Only accessible by authenticated user) */}
            <Route 
                path="/sme" 
            ...
            {/* 8. SME Setup Wizard (first-time onboarding) */}
            <Route
              path="/setup"
              element={<ProtectedRoute><SetupWizard /></ProtectedRoute>}
            />

            {/* 9. Public Rider PWA (Token-based access, requires no general authentication) */}
