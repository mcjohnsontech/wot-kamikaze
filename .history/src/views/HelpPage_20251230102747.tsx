...
import { Container, Paper, Title, Text, Stack, Card, Group, Accordion, Button, ThemeIcon } from '@mantine/core';
import { IconHelpCircle, IconMail, IconPhone, IconBook } from '@tabler/icons-react';
    ...
    <Container size="lg" py="xl">
      <Stack gap="xl">
        ...
        <Group justify="space-between" align="flex-start" mb="lg">
          <Stack gap="xs">
            <Title order={1}>📚 WOT Help Center</Title>
            <Text c="dimmed">Everything you need to know about the Dashboard</Text>
          </Stack>
          <Link to="/sme">
        ...
        {/* Footer */}
        <Card withBorder padding="lg" ta="center">
          <Text c="dimmed" size="sm">
            <span style={{ fontWeight: 600 }}>WOT:</span> Built for Smarter Workflows, Better Visibility, and Greener Growth.
          </Text>
        </Card>
      </Stack>
    </Container>
